...
class UserParameters:
    ...
    def __init__(self, target, initialProgram='', shadowValue=''):
        ...
        self.ctxCfgFlags1
        self.ctxCallBack
        self.ctxKeyboardLayout
        self.ctxMinEncryptionLevel
        self.ctxNWLogonServer
        self.ctxWFHomeDir
        self.ctxWFHomeDirDrive
        self.ctxInitialProgram
        self.ctxMaxConnectionTime
        self.ctxMaxDisconnectionTime
        self.ctxMaxIdleTime
        self.ctxWFProfilePath
        self.ctxShadow
        self.ctxWorkDirectory
        self.ctxCallbackNumber
        self.InheritInitialProgram
        self.InheritCallback
        self.InheritCallbackNumber
        self.InheritShadow
        self.InheritMaxSessionTime
        self.InheritMaxDisconnectionTime
        self.InheritMaxIdleTime
        self.InheritAutoClient
        self.InheritSecurity
        self.PromptForPassword
        self.ResetBroken
        self.ReconnectSame
        self.LogonDisabled
        self.AutoClientDrives
        self.AutoClientPrinters
        self.ForceClientPrinterAsDefault
        self.DisableEncryption
        self.HomeDirectoryMapRoot
        self.UseDefaultGINA
        self.DisableClientPrinterRedirection
        self.DisableClientDriveRedirection
        self.DisableClientComPortRedirection
        self.DisableClientPrinterPortRedirection
        self.DisableClientClipboardRedirection
        self.DisableExeFileExecution
        self.DisableWallpaper
        self.DisableClientAudioRedirection

    @property
    def ctxCfgPresent(self):
        return self.properties["CtxCfgPresent"].GetValueUInt32() if (self.properties.ContainsKey("CtxCfgPresent")) else None
    @ctxCfgPresent.setter
    def ctxCfgPresent(self, value):
        if (value == None):
            del self.properties["CtxCfgPresent"]
            return
        if ("CtxCfgPresent" in self.properties):
            self.properties["CtxCfgPresent"] = new ActiveDirectoryUserParametersProperty()
            self.properties["CtxCfgPresent"].name = "CtxCfgPresent"
        self.properties["CtxCfgPresent"].SetValueUInt32(value.Value)
    ...
    @property
    def ctxMinEncryptionLevel(self):
    {
    ...
    @property
    def ctxMaxDisconnectionTime(self):
    {
    ...
    @property
    def inheritInitialProgram(self):
    {
    ...
    @property
    def inheritCallbackNumber(self):
    {
    ...
    @property
    def inheritMaxSessionTime(self):
    {
    ...
    @property
    def inheritMaxDisconnectionTime(self):
    {
    ...
    @property
    def forceClientPrinterAsDefault(self):
    {
    ...
    @property
    def disableClientPrinterRedirection(self):
    {
    ...
    @property
    def disableClientDriveRedirection(self):
    {
    ...
    @property
    def disableClientComPortRedirection(self):
    {
    ...
    @property
    def disableClientPrinterPortRedirection(self):
    {
    ...
    @property
    def disableClientClipboardRedirection(self):
    {
    ...
    @property
    def disableExeFileExecution(self):
    {
    ...
    @property
    def disableClientAudioRedirection(self):
    {
